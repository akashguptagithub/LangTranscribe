# -*- coding: utf-8 -*-
"""Akash_Kumar_Gupta-Project.ipynb
...
akashvar = tgt_tokenizer.encode('प्रीतम')
print(akashvar)

targetakash = tgt_tokenizer.decode(akashvar)
targetakash
...
greedyakash = rnn_greedy_generate(
        model, 'akash', src_tokenizer, tgt_tokenizer,
        max_length = rnn_enc_dec_data_params['tgt_padding']
    )
greedyakash
